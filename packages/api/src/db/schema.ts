...
export const ciInstances = pgTable(
  ...
  (table) => [uniqueIndex('ci_instances_org_url_idx').on(table.organizationId, table.baseUrl)],
);
...
export const jobs = pgTable(
  ...
  (table) => [uniqueIndex('jobs_instance_path_idx').on(table.ciInstanceId, table.fullPath)],
);
...
export const builds = pgTable(
  ...
  (table) => [uniqueIndex('builds_job_number_idx').on(table.jobId, table.buildNumber)],
);
