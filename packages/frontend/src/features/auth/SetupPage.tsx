/**
 * SetupPage — Sign-up + Jenkins setup flows.
 *
 * NOT routed. Preserved for the future invitation system.
 * Wire to the router when self-service sign-up is re-enabled.
 */
          ...
          <Stack gap="lg">
            <Box>
              <Text size="lg" fw={700} c={colors.text}>
                {mode === "signup" ? "Get started" : "Connect Jenkins"}
              </Text>
            ...
            {mode === "signup" && (
              <>
                ...
                <Text size="xs" c={colors.textMuted} ta="center">
                  ...
                  <Anchor size="xs" c={colors.accent} fw={600} href="/login">
                    Sign in
                  </Anchor>
                </Text>
              </>
            ...
            {mode === "setup" && (
              <>
                ...
                <Text size="xs" c={colors.textMuted} ta="center">
                  You can find your API token in Jenkins &rarr; Your Name
                  &rarr; Configure &rarr; API Token
                </Text>
              </>
            )}
          </Stack>
