...
import { analyzeLog } from '../engine/pattern-matcher';
import { classifyFailure } from '../engine/infra-code-classifier';
import { FAILURE_PATTERNS } from '../engine/failure-patterns';
...
export function BuildAnalysisPage() {
  ...
  const {
    ...
    isLoading,
    error,
  } = useBuildLog(jobPath, buildNumber);
    ...
    <Stack gap="lg" p="md">
      ...
      <Group justify="space-between" align="flex-start">
        <div>
          ...
          <Text size="sm" c="dimmed">{jobPath}</Text>
        </div>
        {analysis && <InfraCodeBadge classification={analysis.classification} />}
      </Group>
